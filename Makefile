...
remove-network:
	docker network rm faustbr_default || true
...
send-page-view-event:
	PYTHONPATH=faustbr venv/bin/faust -A app send page_views '${payload}'

list-agents:
	PYTHONPATH=faustbr venv/bin/faust -A app agents

# Build docker image
build:
	docker build -t faustbr .
